...
WSGI_APPLICATION = 'AMCAPP.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),   # This includes your /static/ folder
]

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Extra - Serve compressed static files
